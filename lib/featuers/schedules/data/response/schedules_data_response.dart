...
part 'schedules_data_response.g.dart';

@JsonSerializable()
class SchedulesDataResponse {
  @JsonKey(name: 'mal_id')
  int? malId;
  @JsonKey(name: 'url')
  String? url;
  ...
  factory SchedulesDataResponse.fromJson(Map<String, dynamic> json) =>
      _$SchedulesDataResponseFromJson(json);

  Map<String, dynamic> toJson(SchedulesDataResponse instance) =>
      _$SchedulesDataResponseToJson(instance);
}
