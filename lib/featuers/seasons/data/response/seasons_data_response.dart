...
part 'seasons_data_response.g.dart';

@JsonSerializable()
class SeasonsDataResponse {
  @JsonKey(name: 'mal_id')
  int? malId;
  @JsonKey(name: 'url')
  String? url;
  ...
  factory SeasonsDataResponse.fromJson(Map<String, dynamic> json) =>
      _$SeasonsDataResponseFromJson(json);

  Map<String, dynamic> toJson(SeasonsDataResponse instance) =>
      _$SeasonsDataResponseToJson(instance);
}
