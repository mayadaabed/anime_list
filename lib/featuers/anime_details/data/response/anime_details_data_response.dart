...
import '../../../search/data/response/search_broadcast_response.dart';
import '../../../search/data/response/trailer_response.dart';
import 'anime_details_external_response.dart';
import 'anime_details_theme_response.dart';
import 'relations_response.dart';
...
class AnimeDetailsDataResponse {
  ...
  bool? approved;
  @JsonKey(name: 'titles')
  List<MangaTitlesReponse>? titles;
  @JsonKey(name: 'title')
  String? title;
  ...
  List<RelationsResponse>? relations;
  @JsonKey(name: 'theme')
  AnimeDetailsTheme? theme;
  @JsonKey(name: 'external')
  List<AnimeDetailsExternalResponse>? external;
  @JsonKey(name: 'streaming')
  List<AnimeDetailsExternalResponse>? streaming;
  ...
  Map<String, dynamic> toJson(AnimeDetailsDataResponse instance) =>
      _$AnimeDetailsDataResponseToJson(instance);
}
