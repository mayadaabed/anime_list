...
import 'anime_details_external_model.dart';
import 'anime_details_theme_model.dart';
import 'relations_model.dart';

class AnimeDetailsDataModel {
  int? malId;
  String? url;
  ImagesModel? images;
  ...
  List<RelationsModel>? relations;
  AnimeDetailsThemeModel? theme;
  List<AnimeDetailsExternalModel>? external;
  List<AnimeDetailsExternalModel>? streaming;

  AnimeDetailsDataModel({
    this.malId,
    this.url,
    this.images,
    this.trailer,
